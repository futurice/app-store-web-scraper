...
import pytest
from app_store_web_scraper import AppReview, AppStoreEntry, AppStoreSession
...
def session(httpserver: HTTPServer) -> AppStoreSession:
    ...
    session._itunes_rss_base_url = httpserver.url_for("")
    return session
...
class TestAppReviews:
    ...
    # TODO: test_empty_feed
    # TODO: test_app_not_found
